        ...
        callback: function (result) {
            if(result){
                $.ajax({
                    ...
                    success : function(data){
                        dashboard.drawTable();
                        bootbox.alert("Productroduct has been delete successfully")
                    } 
                })
            }
        }
        ...
        if($('#productId').val() == 0){
            ...
            $.ajax({
                ...
                $('#addEditModal').modal('hide');
                    dashboard.drawTable();
                    bootbox.alert("Productroduct has been added successfully");
                }
            })
        }
        else{ //up
            ...
            $.ajax({
                ...
                $('#addEditModal').modal('hide');
                    dashboard.drawTable();
                    bootbox.alert("Productroduct has been update successfully");
                }
            })
        }
    }; 
